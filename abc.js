...
function PredictionForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setPrediction(response.data.severity);
    } catch (error) {
    ...
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <input
          ...
          value={inputData.Traffic_Control}
          onChange={handleChange}
        ...
        <input
          ...
          value={inputData.Lighting_Condition}
          onChange={handleChange}
          placeholder="Lighting Condition"
        />
        <input
          type="text"
          name="Vehicle_Type"
      ...
      {prediction && (
        <div>
          <h3>Predicted Severity: {prediction}</h3>
        </div>
      )}
    </div>
  );
